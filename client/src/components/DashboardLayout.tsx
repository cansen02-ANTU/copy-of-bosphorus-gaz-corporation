...
export default function DashboardLayout({
  ...
  const safeAdminUser = { username: adminUser.username ?? "Admin", role: adminUser.role };
  ...
  return (
    ...
    >
      <DashboardLayoutContent setSidebarWidth={setSidebarWidth} adminUser={safeAdminUser}>
        {children}
