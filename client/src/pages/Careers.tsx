    ...
    <div className="pt-20">
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="container">
          <h2 className="text-2xl font-bold text-[#1e3a5f] mb-4">{t("İnsan Kaynakları Politikamız", "Our Human Resources Policy")}</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, i) => (
              ...
              >
                ...
                <h3 className="text-[#1e3a5f] font-semibold mb-2">{t(value.titleTr, value.titleEn)}</h3>
                <p className="text-slate-500 text-sm leading-relaxed">{t(value.descTr, value.descEn)}</p>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-[#1e3a5f] mb-4">
              {t("İş Başvurusu", "Job Application")}
            </h2>
            ...
            <button
              onClick={() => {
                window.location.href = `mailto:kariyer@bosphorusgaz.com?subject=${encodeURIComponent(t("İş Başvurusu", "Job Application"))}`;
                toast(t("E-posta istemciniz açılıyor...", "Opening your email client..."), { description: "kariyer@bosphorusgaz.com" });
              }}
            ...
            >
              ...
              {t("İş Başvurusu Yap", "Apply for a Job")}
            </button>
