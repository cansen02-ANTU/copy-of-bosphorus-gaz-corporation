...
const timelineEvents = [
  { date: "07.04.2003", titleTr: "Kuruluş", titleEn: "Establishment", descTr: "Bosphorus Gaz Corporation A.Ş. kuruldu.", descEn: "Bosphorus Gaz Corporation A.Ş. was founded." },
  { date: "16.12.2003", titleTr: "Bursa İhalesi", titleEn: "Bursa Tender", descTr: "Bosphorus Gaz Corporation \"Bursa Doğal Gaz Dağıtım\" ihalesine katıldı.", descEn: "Bosphorus Gaz Corporation participated in the \"Bursa Natural Gas Distribution\" tender." },
  { date: "02.04.2004", titleTr: "Ortaklık Değişikliği", titleEn: "Partnership Change", descTr: "Zarubezhgaz Management und Beteiligungsgesellschaft mbH (ZMB), Tur Enerji A.Ş.'nin hisselerinin %40'ını almıştır.", descEn: "Zarubezhgaz Management und Beteiligungsgesellschaft mbH (ZMB) acquired 40% of Tur Enerji A.Ş.'s shares." },
  { date: "27.01.2005", titleTr: "İzmir İhalesi", titleEn: "Izmir Tender", descTr: "Bosphorus Gaz Corporation \"İzmir Doğal Gaz Dağıtım Lisansı\" ihalesine katıldı.", descEn: "Bosphorus Gaz Corporation participated in the \"Izmir Natural Gas Distribution License\" tender." },
  { date: "30.11.2005", titleTr: "Devir İhalesi Kazanıldı", titleEn: "Transfer Tender Won", descTr: "BOTAŞ'ın açmış olduğu \"Doğal Gaz Alım Satım Sözleşmeleri (İthalat Sözleşmeleri) Devir İhalesi\" kazanıldı.", descEn: "The \"Natural Gas Purchase and Sale Agreements (Import Contracts) Transfer Tender\" opened by BOTAŞ was won." },
  { date: "22.05.2007", titleTr: "Üçlü Anlaşma", titleEn: "Trilateral Agreement", descTr: "BOTAŞ, Gazprom Export ve Bosphorus Gaz arasındaki üçlü anlaşma Ankara'da imzalandı. Bosphorus Gaz ile Gazprom Export arasında 2021 yılı sonuna kadar geçerli yıllık 750 Milyon m³ Doğal Gaza ilişkin Satış Sözleşmesi imzalandı.", descEn: "The trilateral agreement between BOTAŞ, Gazprom Export and Bosphorus Gaz was signed in Ankara. A Sales Agreement for 750 million m³ of natural gas per year, valid until the end of 2021, was signed between Bosphorus Gaz and Gazprom Export." },
  { date: "11.07.2007", titleTr: "Rekabet Kurumu Onayı", titleEn: "Competition Board Approval", descTr: "Şirketimiz Rekabet Kurumu tarafından onaylanmıştır.", descEn: "Our company was approved by the Competition Board." },
  { date: "18.10.2007", titleTr: "İthalat Lisansı", titleEn: "Import License", descTr: "Bosphorus Gaz Corporation, EPDK'dan \"İthalat Lisansı\" aldı.", descEn: "Bosphorus Gaz Corporation obtained an \"Import License\" from EMRA." },
  { date: "03.01.2009", titleTr: "İthalat Başlangıcı", titleEn: "Import Operations Begin", descTr: "Bosphorus Gaz, Doğal Gaz ithalat ve toptan satış faaliyetine başladı.", descEn: "Bosphorus Gaz commenced natural gas import and wholesale operations." },
  { date: "31.12.2011", titleTr: "Pazar Payı", titleEn: "Market Share", descTr: "737,3 milyon Sm³ gaz ithalatı ile ülkemiz ithalatında %1.7'lik pay sahibi oldu.", descEn: "Achieved a 1.7% share of Turkey's imports with 737.3 million Sm³ of gas imports." },
  { date: "23.12.2011", titleTr: "Kazakistan Kontratı", titleEn: "Kazakhstan Contract", descTr: "Kazakistan'dan yıllık 750 milyon metreküp gaz ithalatı yapmak üzere kontrat imzalandı.", descEn: "A contract was signed to import 750 million cubic meters of gas per year from Kazakhstan." },
  { date: "05.06.2012", titleTr: "Hisse Devri", titleEn: "Share Transfer", descTr: "TUR Enerji yüzde 20 oranında hisselerini Gazprom Germania'ya devretti.", descEn: "TUR Enerji transferred 20% of its shares to Gazprom Germania." },
  { date: "31.07.2012", titleTr: "Hisse Devri", titleEn: "Share Transfer", descTr: "TUR Enerji yüzde 11 oranında hisselerini Gazprom Germania'ya devretti. Hisse dağılımı %71 Gazprom Germania, %29 Tur Enerji oldu.", descEn: "TUR Enerji transferred 11% of its shares to Gazprom Germania. Share distribution became 71% Gazprom Germania, 29% Tur Enerji." },
  { date: "09.08.2012", titleTr: "Yeni Kontrat", titleEn: "New Contract", descTr: "Gazprom Export ile Batı Hattından yılda 1 milyar 750 milyon metreküp doğal gaz ithalatı yapmak üzere anlaşma imzalandı.", descEn: "An agreement was signed with Gazprom Export to import 1.75 billion cubic meters of natural gas per year via the Western Pipeline." },
  { date: "20.09.2012", titleTr: "Elektrik Lisansı", titleEn: "Electricity License", descTr: "Elektrik Toptan Satış Lisansı alındı.", descEn: "Electricity Wholesale License was obtained." },
  { date: "01.01.2013", titleTr: "İkinci Kontrat Aktif", titleEn: "Second Contract Active", descTr: "1,75 milyar Sm³'lük ikinci ithalat kontratı ile gaz ithalat faaliyetine başlandı. Toplamda 2,5 milyar Sm³ kontrat büyüklüğüne ulaşıldı.", descEn: "Gas import operations began with the second import contract of 1.75 billion Sm³. Total contract volume reached 2.5 billion Sm³." },
  { date: "17.01.2013", titleTr: "Spot LNG Lisansı", titleEn: "Spot LNG License", descTr: "10 yıl süre ile geçerli Spot LNG Lisansı alındı.", descEn: "A Spot LNG License valid for 10 years was obtained." },
  { date: "31.12.2014", titleTr: "Rekor İthalat", titleEn: "Record Imports", descTr: "2.748,13 milyon Sm³ doğalgaz ithalatı ile ülkemiz ithalatında %5,58 pay sahibi oldu.", descEn: "Achieved a 5.58% share of Turkey's imports with 2,748.13 million Sm³ of natural gas imports." },
  { date: "01.09.2020", titleTr: "Spot İthalat", titleEn: "Spot Import", descTr: "EPDK tarafından ihaleye açılan spot ithalat kapasitesinden kapasite alarak Türkiye'nin ilk spot ithalat yapan özel tedarikçisi oldu.", descEn: "Became Turkey's first private supplier to conduct spot imports by acquiring capacity from EMRA's spot import tender." },
  { date: "18.10.2022", titleTr: "Kontrat Uzatma", titleEn: "Contract Extension", descTr: "Türkiye'de bir ilk gerçekleştirerek 2021 yılında biten doğalgaz kontratını Gazprom ile 2043 yılına kadar uzattı. Yıllık 2,5 milyar metreküp ile Türkiye'nin en büyük özel doğalgaz ithalatçısı konumuna geldi.", descEn: "Achieving a first in Turkey, extended the natural gas contract that ended in 2021 with Gazprom until 2043. Became Turkey's largest private natural gas importer with 2.5 billion cubic meters per year." },
  { date: "24.11.2022", titleTr: "Spot İthalat Lisansı", titleEn: "Spot Import License", descTr: "Spot LNG Lisansı spot boru gazı ithalatına da izin verecek şekilde Spot İthalat Lisansı olarak güncellendi. Lisans 30 yıl süreyle geçerlidir.", descEn: "The Spot LNG License was updated to a Spot Import License to also allow spot pipeline gas imports. The license is valid for 30 years." },
  { date: "07.09.2023", titleTr: "İhracat Lisansı", titleEn: "Export License", descTr: "30 yıl süre ile geçerli Doğal Gaz İhracat Lisansı alındı.", descEn: "A Natural Gas Export License valid for 30 years was obtained." },
];
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a5f] mb-6">{t("Şirket Profili", "Company Profile")}</h2>
            ...
            <div className="relative">
              <img
                ...
                alt={t("Doğal gaz altyapısı", "Natural gas infrastructure")}
      ...
      <section id="vizyon" className="py-20 border-t border-slate-100 bg-slate-50">
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">{t("Vizyonumuz", "Our Vision")}</h3>
            ...
            <motion.div
              ...
              className="bg-white border border-slate-100 rounded-xl p-8 shadow-sm"
            >
              <h3 className="text-xl font-bold text-[#1e3a5f] mb-4">{t("Misyonumuz", "Our Mission")}</h3>
              <p className="text-slate-600 leading-relaxed">
                {t(
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="container">
          <h2 className="text-2xl font-bold text-[#1e3a5f] mb-8">
            {t("Ortaklık Yapısı", "Ownership Structure")}
          </h2>
          ...
          <p className="text-slate-400 text-xs mt-4">
            {t("* Doğrudan ve dolaylı paylar dahil.", "* Including direct and indirect shares.")}
          </p>
      ...
      <section className="py-20 border-t border-slate-100 bg-slate-50">
        <div className="container">
          <h2 className="text-2xl font-bold text-[#1e3a5f] mb-4">
            {t("Yönetim", "Management")}
          </h2>
          <p className="text-slate-500 mb-10 max-w-xl">
            {t("Bosphorus Gaz Corporation yönetim kadrosu.", "Bosphorus Gaz Corporation management team.")}
          </p>
            ...
            {managementTeam.map((member, i) => (
              ...
              >
                ...
                <p className="text-[#1d4ed8] text-xs font-medium">
                  {lang === "en" ? member.titleEn : member.titleTr}
                </p>
              </motion.div>
            ))}
          </div>
                ...
                >
                  ...
                  <div className={`ml-10 lg:ml-0 lg:w-1/2 ${i % 2 === 0 ? "lg:pr-12 lg:text-right" : "lg:pl-12"}`}>
                    ...
                    <h4 className="text-[#1e3a5f] font-semibold mt-1">
                      {lang === "en" ? event.titleEn : event.titleTr}
                    </h4>
                    <p className="text-slate-500 text-sm mt-1">
                      {lang === "en" ? event.descEn : event.descTr}
                    </p>
                  </div>
                </motion.div>
              ))}
      ...
      <section id="bilgi-toplumu" className="py-16 border-t border-slate-100">
        <div className="container">
          ...
          <div className="text-slate-500 text-sm space-y-2 max-w-2xl">
            <p><strong className="text-slate-700">{t("Ticaret Unvanı:", "Trade Name:")}</strong> Bosphorus Gaz Corporation A.Ş.</p>
            <p><strong className="text-slate-700">{t("Merkez Adresi:", "Headquarters:")}</strong> Seba Center, Darüşşafaka Cad. No:45, Sarıyer, İstanbul</p>
            <p><strong className="text-slate-700">{t("Ticaret Sicil No:", "Trade Registry No:")}</strong> {t("İstanbul Ticaret Sicili", "Istanbul Trade Registry")}</p>
            <p><strong className="text-slate-700">{t("MERSIS No:", "MERSIS No:")}</strong> —</p>
            <p><strong className="text-slate-700">{t("KEP Adresi:", "KEP Address:")}</strong> bosphorusgaz@hs01.kep.tr</p>
          </div>
        </div>
      </section>
    </div>
