    ...
    <div>
        ...
        <div className="container">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div className="text-center lg:text-left">
              ...
              <p className="text-slate-500 text-sm mt-2">{t("Yıllık Kapasite", "Annual Capacity")}</p>
            </div>
            <div className="text-center lg:text-left">
              <AnimatedCounter end={2003} suffix="" duration={1500} />
              <p className="text-slate-500 text-sm mt-2">{t("Kuruluş Yılı", "Established")}</p>
            </div>
            <div className="text-center lg:text-left">
              ...
              <p className="text-slate-500 text-sm mt-2">{t("Özel Pazar Payı", "Private Market Share")}</p>
            </div>
            <div className="text-center lg:text-left">
              <AnimatedCounter end={2043} suffix="" duration={1500} />
              <p className="text-slate-500 text-sm mt-2">{t("Tedarik Kontratı", "Supply Contract")}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img
                ...
                alt={t("Bosphorus Gaz altyapısı", "Bosphorus Gaz infrastructure")}
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                <p className="text-xs text-slate-400 mb-3">{t(news.dateTr, news.dateEn)}</p>
                <h3 className="text-[#1e3a5f] font-semibold mb-3 group-hover:text-[#1d4ed8] transition-colors duration-200 line-clamp-2">
                  {t(news.titleTr, news.titleEn)}
                </h3>
                <p className="text-slate-500 text-sm leading-relaxed line-clamp-3">
                  {t(news.excerptTr, news.excerptEn)}
                </p>
              </motion.article>
            ))}
          </div>
      ...
      <section className="py-20 lg:py-24 bg-gradient-to-r from-[#1e3a5f] to-[#2563eb]">
        <div className="container text-center">
          ...
          >
            {t("Teklif Talep Edin", "Request a Supply Quote")}
          </Link>
        </div>
      </section>
    </div>
