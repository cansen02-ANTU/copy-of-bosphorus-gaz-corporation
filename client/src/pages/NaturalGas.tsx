  ...
  return (
    <div className="pt-20">
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold text-white mb-6">
              {t("Faaliyetlerimiz", "Our Activities")}
            </h1>
      ...
      <section className="py-20 border-t border-slate-100">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a5f] mb-6">{t("İthalat & Toptan Satış", "Import & Wholesale")}</h2>
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-xl p-8">
              <h3 className="text-lg font-semibold text-[#1e3a5f] mb-6">{t("Türkiye Doğal Gaz Tüketimi", "Turkey's Natural Gas Consumption")}</h3>
      ...
      <section id="piyasa" className="py-20 border-t border-slate-100 bg-slate-50">
        <div className="container">
          <h2 className="text-2xl font-bold text-[#1e3a5f] mb-8">{t("Piyasa Görünümü", "Market Overview")}</h2>
      ...
      <section id="talep" className="py-20 border-t border-slate-100">
        <div className="container max-w-3xl">
          <h2 className="text-2xl font-bold text-[#1e3a5f] mb-3">{t("Doğal Gaz Bilgi Formu", "Natural Gas Information Form")}</h2>
          ...
          {formSubmitted ? (
            ...
            >
              ...
              <h3 className="text-[#1e3a5f] font-semibold mb-2">{t("Talebiniz Alındı", "Your Request Has Been Received")}</h3>
              <p className="text-slate-500 text-sm">{t("Ekibimiz en kısa sürede sizinle iletişime geçecektir.", "Our team will contact you as soon as possible.")}</p>
            </motion.div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Company Info */}
              <div>
                <h3 className="text-sm font-semibold text-[#1e3a5f] uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">{t("Firma Bilgileri", "Company Information")}</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Firma Adı *", "Company Name *")}</label>
                    <input
                      type="text"
                      required
                      ...
                      placeholder={t("Firma adınız", "Your company name")}
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("İletişim Kişisi *", "Contact Person *")}</label>
                    <input
                      type="text"
                      required
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                  ...
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("E-posta *", "Email *")}</label>
                    <input
                      type="email"
                      required
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                      placeholder={t("ornek@firma.com", "example@company.com")}
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Telefon *", "Phone *")}</label>
                    <input
                      type="tel"
                      required
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
              ...
              {/* Facility Info */}
              <div>
                <h3 className="text-sm font-semibold text-[#1e3a5f] uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">{t("Gaz Talep Edilen Tesise Ait Bilgiler", "Facility Information for Gas Request")}</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Tesis Adresi *", "Facility Address *")}</label>
                    <input
                      type="text"
                      required
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                      placeholder={t("Tesis adresi", "Facility address")}
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Tesis İli *", "Facility Province *")}</label>
                    <input
                      type="text"
                      required
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                      placeholder={t("İl", "Province")}
                    />
                  </div>
                </div>
              </div>
              ...
              {/* Gas Usage */}
              <div>
                <h3 className="text-sm font-semibold text-[#1e3a5f] uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">{t("Tesisin Gaz Kullanımı", "Facility Gas Usage")}</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Yıllık Tüketim *", "Annual Consumption *")}</label>
                    <select
                      required
                  ...
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Kullanım Amacı", "Purpose of Use")}</label>
                    <select
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                    >
                      <option value="">{t("Seçiniz", "Select")}</option>
                      <option value="uretim">{t("Üretim / İmalat", "Production / Manufacturing")}</option>
                      <option value="enerji">{t("Enerji Üretimi", "Energy Generation")}</option>
                      <option value="isitma">{t("Isıtma", "Heating")}</option>
                      <option value="diger">{t("Diğer", "Other")}</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h3 className="text-sm font-semibold text-[#1e3a5f] uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">{t("Tesisin Aylık Ortalama Gaz Kullanımı", "Monthly Average Gas Usage")}</h3>
              ...
              {/* Personnel Info */}
              <div>
                <h3 className="text-sm font-semibold text-[#1e3a5f] uppercase tracking-wider mb-4 border-b border-slate-100 pb-2">{t("İlgili Personel Bilgisi", "Contact Personnel Information")}</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Ad Soyad", "Full Name")}</label>
                    <input
                      type="text"
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                      placeholder={t("İlgili personel", "Contact person")}
                    />
                  </div>
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Pozisyon", "Position")}</label>
                    <input
                      type="text"
                      className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                      placeholder={t("Ünvan / Pozisyon", "Title / Position")}
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm text-slate-600 mb-1.5">{t("Ek Notlar", "Additional Notes")}</label>
                <textarea
                  rows={3}
                  ...
                  placeholder={t("Ek bilgi veya özel talepleriniz...", "Additional information or special requests...")}
                />
              </div>
