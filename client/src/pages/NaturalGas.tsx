    ...
    <div className="pt-20">
      ...
      <section className="relative py-24 lg:py-32 overflow-hidden bg-gradient-to-br from-[#1e3a5f] to-[#2563eb]">
        <div className="absolute inset-0 opacity-15">
          <img
            src="/images/bg_images/energy-abstract.webp"
            alt=""
          ...
          <div className="max-w-4xl space-y-4 text-slate-600 leading-relaxed">
            ...
            <p>
              {t(
                ...
                "In addition to LNG terminals, which play an important role in seasonal and daily consumption balancing, Underground Gas Storage Facilities were also opened to third-party access with the KUE that came into effect in 2012.\n\nOn September 1, 2018, the Organized Natural Gas Wholesale Market became operational under EPİAŞ. Day-ahead, intraday, and day-after Spot natural gas trading and system balancing activities also began to be conducted through the market.\n\nAs of October 1, 2021, futures trading for future periods became possible through the Futures Natural Gas Market.\n\nIn April 2024, with the entry into force of the Procedures and Principles Regarding the Use of Natural Gas Export Exit Points, private sector players holding export licenses became able to conduct pipeline gas exports.",
                "Помимо терминалов СПГ, играющих важную роль в сезонном и суточном балансировании потребления, подземные хранилища газа также были открыты для доступа третьих сторон согласно KUE, вступившим в силу в 2012 году.\n\n1 сентября 2018 года под эгидой EPİAŞ начал работу Организованный оптовый рынок природного газа. Спотовая торговля природным газом (на день вперёд, внутридневная, на день после) и деятельность по балансировке системы также начали осуществляться через рынок.\n\nС 1 октября 2021 года благодаря Срочному рынку природного газа стала возможна фьючерсная торговля на будущие периоды.\n\nВ апреле 2024 года, с вступлением в силу Правил и принципов использования точек выхода для экспорта природного газа, участники частного сектора, имеющие экспортные лицензии, получили возможность осуществлять экспорт трубопроводного газа."
              )}
            </p>
          </div>
        </div>
