      ...
      <section className="py-20 border-t border-slate-100">
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Left: Info + Map */}
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a5f] mb-8">{t("İletişim Bilgileri", "Contact Information")}</h2>
              <div className="space-y-6 mb-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[#1e3a5f] font-semibold text-sm">{t("Adres", "Address")}</h3>
                    <p className="text-slate-500 text-sm mt-1">
                      Seba Center, Darüşşafaka Cad. No:45<br />
                      {t("Sarıyer, İstanbul, Türkiye", "Sarıyer, Istanbul, Turkey")}
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[#1e3a5f] font-semibold text-sm">{t("Telefon", "Phone")}</h3>
                    <p className="text-slate-500 text-sm mt-1">+90 (212) 000 00 00</p>
                    <p className="text-slate-500 text-sm">+90 (212) 000 00 01 ({t("Faks", "Fax")})</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-lg bg-blue-50 border border-blue-100 flex items-center justify-center shrink-0">
                  ...
                  <div>
                    <h3 className="text-[#1e3a5f] font-semibold text-sm">{t("E-posta", "Email")}</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-[#1e3a5f] font-semibold text-sm">{t("Çalışma Saatleri", "Working Hours")}</h3>
                    <p className="text-slate-500 text-sm mt-1">{t("Pazartesi – Cuma: 09:00 – 18:00", "Monday – Friday: 09:00 – 18:00")}</p>
                    <p className="text-slate-500 text-sm">{t("Cumartesi – Pazar: Kapalı", "Saturday – Sunday: Closed")}</p>
                  </div>
                </div>
              </div>
            ...
            {/* Right: Contact Form */}
            <div>
              <h2 className="text-2xl font-bold text-[#1e3a5f] mb-8">{t("İletişim Formu", "Contact Form")}</h2>
              {submitted ? (
                <motion.div
                ...
                >
                  ...
                  <h3 className="text-[#1e3a5f] font-semibold mb-2">{t("Mesajınız Gönderildi", "Your Message Has Been Sent")}</h3>
                  <p className="text-slate-500 text-sm">{t("En kısa sürede size dönüş yapacağız.", "We will get back to you as soon as possible.")}</p>
                </motion.div>
              ) : (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-md text-slate-800 text-sm placeholder:text-slate-300 focus:border-[#1d4ed8] focus:ring-1 focus:ring-[#1d4ed8]/20 focus:outline-none transition-colors"
                        placeholder={t("ornek@email.com", "example@email.com")}
                      />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Konu *", "Subject *")}</label>
                    <select
                      required
                    ...
                    >
                      ...
                      <option value="tedarik">{t("Doğal Gaz Tedarik", "Natural Gas Supply")}</option>
                      <option value="isbirligi">{t("İş Birliği", "Partnership")}</option>
                      <option value="basin">{t("Basın & Medya", "Press & Media")}</option>
                      <option value="kariyer">{t("Kariyer", "Careers")}</option>
                      <option value="diger">{t("Diğer", "Other")}</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-sm text-slate-600 mb-1.5">{t("Mesaj *", "Message *")}</label>
                    <textarea
                      rows={5}
                      required
